...
ActiveRecord::Schema[7.0].define(version: 2023_01_29_000535) do
  ...
  add_foreign_key "anatomy_sub_sections", "anatomy_sections"
  add_foreign_key "articles", "editors"
  add_foreign_key "editor_roles", "editors"
  add_foreign_key "editor_roles", "roles"
  add_foreign_key "lab_sections", "labs"
  add_foreign_key "lab_sub_sections", "lab_sections"
  add_foreign_key "lab_videos", "labs"
  add_foreign_key "labels", "polygons"
  add_foreign_key "labels_type_join_tables", "label_types"
  add_foreign_key "labels_type_join_tables", "labels"
end
